...
def seed_database(force_reseed=False):
    ...
    try:
        ...
        if force_reseed or db.query(models.Product).count() > 0:
            print(
                "Clearing tables and reseeding with complete classic product descriptions and comprehensive reviews..."
            )
        ...
        print(
            "Seeding Indian localized e-commerce database with rich product details and 5-star customer reviews..."
        )
        ...
        coupons = [
            models.Coupon(
                code="DESI10", discount_percent=10.0, max_discount=100.0, is_active=True
            ),
            models.Coupon(
                code="NAMASTE20",
        ...
        all_reviews_data = [
            ...
            (
                created_products[0],
                "aarav.sharma@mumbai.in",
                "Aarav Sharma",
                "Mumbai",
                5,
                18,
                "Best apple juice in India! You can genuinely taste the crisp Srinagar apples with zero added sugar. Delivered cold within 30 mins in Mumbai.",
            ),
            (
                created_products[0],
                "sneha.k@pune.in",
                ...
                5,
                12,
                "The aroma when you open the seal is magical. Extremely fresh, authentic texture and no artificial preservatives. My whole family loves it!",
            ),
            (
                created_products[0],
                "rajesh.khanna@delhi.in",
                "Rajesh Khanna",
                "New Delhi",
                5,
                9,
                "Ordered a 6-pack for my morning workout routine. Clean energy and rich in natural antioxidants.",
            ),
            (
                created_products[0],
                "meera.s@chennai.in",
                ...
                4,
                6,
                "Very refreshing and crisp. Arrived in insulated packaging with ice packs. Highly recommended!",
            ),
            # Product 2: Ratnagiri Mango & Apple Pomace
            (
                created_products[1],
                "rohan.deshmukh@ratnagiri.in",
                "Rohan Deshmukh",
                "Ratnagiri",
                5,
                14,
                "Being from Ratnagiri, I know original Alphonso pulp when I taste it. This organic fiber blend is top notch for breakfast oats and baking!",
            ),
            (
                created_products[1],
                "dr.kavita.rao@hyderabad.in",
                "Dr. Kavita Rao",
                "Hyderabad",
                5,
                11,
                "Excellent source of natural prebiotic pectin. Great for gut health, daily digestion, and cholesterol control.",
            ),
            (
                created_products[1],
                "amit.joshi@nagpur.in",
                "Amit Joshi",
                "Nagpur",
                4,
                7,
                "Adds wonderful natural mango aroma and thickness to homemade smoothie bowls. Clean ingredients.",
            ),
            # Product 3: Kerala Nendran Banana Juice
            (
                created_products[2],
                "anoop.menon@kochi.in",
                "Anoop Menon",
                "Kochi",
                5,
                16,
                "Authentic Kerala Wayanad Nendran banana flavor with a touch of green cardamom. The ultimate natural post-workout recovery drink.",
            ),
            (
                created_products[2],
                "deepika.nair@bengaluru.in",
                "Deepika Nair",
                "Bengaluru",
                5,
                13,
                "Rich, smooth, and very filling. Tastes just like traditional South Indian banana nectar without any watery dilution.",
            ),
            (
                created_products[2],
                "vinay.hegde@mangaluru.in",
                "Vinay Hegde",
                "Mangaluru",
                4,
                8,
                "Natural potassium powerhouse. My kids love drinking this before their evening football practice.",
            ),
            # Product 4: Fresh Tulsi & Basil Herbal Smoothie
            (
                created_products[3],
                "dr_ananya@delhi.gov.in",
                "Dr. Ananya Iyer",
                "New Delhi",
                5,
                24,
                "The holy Tulsi and ginger combination is magnificent for boosting morning immunity. High quality cold-pressing!",
            ),
            (
                created_products[3],
                "gaurav.chawla@chandigarh.in",
                "Gaurav Chawla",
                "Chandigarh",
                5,
                15,
                "You feel revitalized after just one glass. The green basil aroma is very soothing and the ginger gives a nice pleasant kick.",
            ),
            (
                created_products[3],
                "pooja.bhatt@dehradun.in",
                "Pooja Bhatt",
                "Dehradun",
                5,
                11,
                "Fresh herbal goodness straight from Uttarakhand hills. 10/10 recommended for daily detox and mental focus.",
            ),
            # Product 5: Himalayan Forest Berry Juice
            (
                created_products[4],
                "rohit.verma@bangalore.tech",
                "Rohit Verma",
                "Bengaluru",
                5,
                21,
                "Very rich Himalayan berry flavor with wild blackberries and strawberries. Paid seamlessly via UPI on PhonePe.",
            ),
            (
                created_products[4],
                "tanvi.singhal@gurugram.in",
                "Tanvi Singhal",
                "Gurugram",
                5,
                17,
                "Packed with antioxidants and has a wonderful ruby red color. Tastes luxurious and fresh, not overly sweet.",
            ),
            (
                created_products[4],
                "karan.kapoor@shimla.in",
                "Karan Kapoor",
                "Shimla",
                5,
                14,
                "Authentic wild mountain berry notes. Perfect balance of natural tartness and fruity sweetness.",
            ),
            # Product 6: OWASP Juice Shop Master Edition
            (
                created_products[5],
                "vikramaditya@mumbai.co",
                "Vikramaditya Singhania",
                "Mumbai",
                5,
                42,
                "Worth every single rupee for true connoisseurs. The 24K gold foil certificate and rare vintage notes make it a museum-grade collector piece!",
            ),
            (
                created_products[5],
                "shreya.oberoi@jaipur.in",
                "Shreya Oberoi",
                "Jaipur",
                5,
                31,
                "A luxurious royal experience beyond words. Kashmiri saffron aroma fills the room as soon as the decanter is opened.",
            ),
            (
                created_products[5],
                "aditya.birla@kolkata.in",
                "Aditya Birla",
                "Kolkata",
                5,
                28,
                "The master packaging, heavy crystal decanter, and gold flakes are unmatched. Proud to own bottle #1 of this limited batch.",
            ),
            # Product 7: Desi Delhi Gajar Carrot Juice
            (
                created_products[6],
                "harpreet.singh@amritsar.in",
                "Harpreet Singh",
                "Amritsar",
                5,
                19,
                "Tastes exactly like fresh winter red carrots from Punjab and Delhi farms! Kala namak gives it the authentic desi punch.",
            ),
            (
                created_products[6],
                "neha.gupta@noida.in",
                ...
                5,
                14,
                "High in Beta-carotene, super fresh and sweet without a single grain of added sugar. My go-to breakfast drink.",
            ),
            (
                created_products[6],
                "rahul.mehra@delhi.in",
                "Rahul Mehra",
                "Delhi",
                4,
                9,
                "Cold-pressed to perfection. Arrived chilled at 4°C via Swiggy Instamart delivery in under 35 minutes.",
            ),
            # Product 8: Exotic Pitaya Dragon Fruit Lassi
            (
                created_products[7],
                "jayesh.parekh@ahmedabad.in",
                "Jayesh Parekh",
                "Ahmedabad",
                5,
                23,
                "The combination of Gujarat dragon fruit and probiotic A2 dahi is pure brilliance. Vibrant magenta color and divine creamy taste!",
            ),
            (
                created_products[7],
                "divya.menon@bengaluru.in",
                "Divya Menon",
                "Bengaluru",
                5,
                16,
                "Chia seeds and wild forest honey add amazing texture. Very refreshing after an evening yoga session.",
            ),
            (
                created_products[7],
                "sunita.reddy@hyderabad.in",
                "Sunita Reddy",
                "Hyderabad",
                5,
                12,
                "Creamy, gut-friendly, and ultra delicious. Reordering this every single week!",
            ),
            # Product 9: Desi Shikanji Nimbu Paani
            (
                created_products[8],
                "priya.patel@ahmedabad.in",
                "Priya Patel",
                "Ahmedabad",
                5,
                29,
                "Authentic Desi Shikanji taste with kala namak and roasted bhuna jeera! The best summer heatbuster in India.",
            ),
            (
                created_products[8],
                "manoj.tiwari@varanasi.in",
                "Manoj Tiwari",
                "Varanasi",
                5,
                20,
                "Street-style refreshment made completely hygienic with organic lemons and natural Khandsari sugar. Pure nostalgia in every sip.",
            ),
            (
                created_products[8],
                "suresh.kumar@lucknow.in",
                "Suresh Kumar",
                "Lucknow",
                5,
                15,
                "Outstanding balance of tangy lemon, rock salt, and mint leaves. Instantly rehydrates in hot weather.",
            ),
            # Product 10: Nagpur Fresh Orange Juice
            (
                created_products[9],
                "vikram.singh@pune.co",
                "Vikram Singh",
                "Nagpur",
                5,
                35,
                "Original Nagpur mandarin orange taste with genuine pulp vesicles. Outstanding citrus burst!",
            ),
            (
                created_products[9],
                "archana.patil@mumbai.in",
                "Archana Patil",
                "Mumbai",
                5,
                22,
                "100% pure Vitamin C without any artificial sourness or added water. Kids finished the 1000ml bottle in a day.",
            ),
            (
                created_products[9],
                "pradeep.shinde@pune.in",
                "Pradeep Shinde",
                "Pune",
                5,
                18,
                "Fabulous cold-pressed quality. You can clearly see and taste the fresh citrus pulp vesicles in every glass.",
            ),
        ]
        ...
        if len(created_products) >= 2:
            item1 = models.BasketItem(
                user_id=demo_user.id, product_id=created_products[0].id, quantity=1
            )
            item2 = models.BasketItem(
                user_id=demo_user.id, product_id=created_products[3].id, quantity=1
            )
            db.add_all([item1, item2])

        db.commit()
        print(
            "Database successfully populated with production-level products and verified customer reviews for all items!"
        )
